...
<body>
	...
	<!--banner-->
		...
		<div class="banner">
			<div class="container">
				<h2 class="hdng"><a href="${pageContext.request.contextPath }/goods_detail?id=${scrollGoods.id}">${scrollGoods.name }</a><span></span></h2>
				<p>今日精选推荐</p>
				<a class="banner_a" href="javascript:;" onclick="buy(${scrollGoods.id})">立刻购买</a>
				<div class="banner-text">		
					<a href="${pageContext.request.contextPath }/goods_detail?id=${scrollGoods.id}">
						<img src="${pageContext.request.contextPath }${scrollGoods.cover }" alt="${scrollGoods.name }" width="350" height="350">
					</a>	
				</div>
			</div>
		</div>
